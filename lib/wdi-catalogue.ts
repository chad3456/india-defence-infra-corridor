...
export const WDI_INDICATORS: WdiIndicator[] = [
  ...
  { code: "GB.XPD.RSDV.GD.ZS", id: "wdi-rd-spending", title: "Research and development expenditure", definition: "Gross domestic R&D spending as a share of GDP.", category: "manufacturing", unit: "% of GDP", unitShort: "%", higherIsBetter: true, note: "India spends around 0.65% of GDP on R&D against China's 2.4%. No defence-industrial ambition survives that gap indefinitely." },
  { code: "IP.PAT.RESD", id: "wdi-patents-resident", title: "Patent applications, residents", definition: "Patent applications filed by residents.", category: "manufacturing", unit: "applications", unitShort: "apps", higherIsBetter: true },
  { code: "IP.PAT.NRES", id: "wdi-patents-nonresident", title: "Patent applications, non-residents", definition: "Patent applications filed by non-residents.", category: "manufacturing", unit: "applications", unitShort: "apps", higherIsBetter: null },
  { code: "IP.JRN.ARTC.SC", id: "wdi-scientific-articles", title: "Scientific and technical journal articles", definition: "Number of scientific and engineering articles published.", category: "manufacturing", unit: "articles", unitShort: "articles", higherIsBetter: true },
