...
export const WDI_INDICATORS: WdiIndicator[] = [
  ...
  // --- Household economy, consumption and prices ---------------------------
  { code: "NE.CON.PRVT.PC.KD", id: "wdi-household-consumption-pc", title: "Household consumption per capita", definition: "Household final consumption expenditure per person, constant 2015 US$.", category: "quality-of-life", unit: "constant 2015 US$", unitShort: "US$", higherIsBetter: true, note: "What a household actually spends, rather than what the economy produces. It tracks GDP per capita loosely, and the gap between them is where the distribution argument sits." },
  { code: "NE.CON.PRVT.ZS", id: "wdi-household-consumption-share", title: "Household consumption, share of GDP", definition: "Household final consumption expenditure as a share of GDP.", category: "economy", unit: "% of GDP", unitShort: "%", higherIsBetter: null },
  { code: "AG.PRD.FOOD.XD", id: "wdi-food-production-index", title: "Food production index", definition: "Food production relative to the 2014-16 base period.", category: "quality-of-life", unit: "index (2014-16 = 100)", unitShort: "index", higherIsBetter: true },
  { code: "SN.ITK.DEFC.ZS", id: "wdi-undernourishment", title: "Prevalence of undernourishment", definition: "Share of the population whose food intake is insufficient to meet dietary energy requirements.", category: "quality-of-life", unit: "% of population", unitShort: "%", higherIsBetter: false, note: "The food-security number that matters most, and the one that has moved least. Read it against the food inflation series rather than instead of it." },
  { code: "SH.STA.STNT.ZS", id: "wdi-child-stunting", title: "Stunting, children under five", definition: "Share of children under five whose height for age is more than two standard deviations below the median.", category: "quality-of-life", unit: "% of children", unitShort: "%", higherIsBetter: false },
  { code: "EG.CFT.ACCS.ZS", id: "wdi-clean-cooking", title: "Access to clean cooking fuel", definition: "Share of the population with primary reliance on clean fuels and technology for cooking.", category: "quality-of-life", unit: "% of population", unitShort: "%", higherIsBetter: true, note: "The Ujjwala scheme's headline claim is a connection count; this is the share who actually cook with it. The two diverge." },

  // --- Financial inclusion and markets --------------------------------------
  { code: "FX.OWN.TOTL.ZS", id: "wdi-account-ownership", title: "Account ownership at a financial institution", definition: "Share of adults aged 15+ with an account at a bank or mobile-money provider.", category: "social", unit: "% of adults 15+", unitShort: "%", higherIsBetter: true, note: "Findex data, collected every three years, so the series is sparse by construction rather than by omission." },
  { code: "FX.OWN.TOTL.FE.ZS", id: "wdi-account-ownership-female", title: "Account ownership, women", definition: "Share of women aged 15+ with an account at a financial institution or mobile-money provider.", category: "social", unit: "% of women 15+", unitShort: "%", higherIsBetter: true },
  { code: "CM.MKT.LCAP.GD.ZS", id: "wdi-market-cap-gdp", title: "Market capitalisation of listed companies", definition: "Market value of domestically listed companies as a share of GDP.", category: "economy", unit: "% of GDP", unitShort: "%", higherIsBetter: null, note: "The closest published proxy for retail equity participation over a long run. Demat account counts are the number people usually quote, and SEBI publishes those separately." },
  { code: "CM.MKT.LDOM.NO", id: "wdi-listed-companies", title: "Listed domestic companies", definition: "Number of domestically incorporated companies listed on the country's stock exchanges at year end.", category: "economy", unit: "companies", unitShort: "cos", higherIsBetter: null },
  { code: "CM.MKT.TRAD.GD.ZS", id: "wdi-stocks-traded", title: "Stocks traded, total value", definition: "Total value of shares traded during the period as a share of GDP.", category: "economy", unit: "% of GDP", unitShort: "%", higherIsBetter: null },
  { code: "FS.AST.PRVT.GD.ZS", id: "wdi-private-credit", title: "Domestic credit to the private sector", definition: "Financial resources provided to the private sector by financial corporations, as a share of GDP.", category: "economy", unit: "% of GDP", unitShort: "%", higherIsBetter: true },

  // --- Travel and tourism ---------------------------------------------------
  { code: "ST.INT.ARVL", id: "wdi-tourist-arrivals", title: "International tourist arrivals", definition: "Number of tourists who travel to a country other than their usual residence for less than a year.", category: "quality-of-life", unit: "arrivals", unitShort: "arrivals", higherIsBetter: true },
  { code: "ST.INT.RCPT.CD", id: "wdi-tourism-receipts", title: "International tourism receipts", definition: "Expenditure by international inbound visitors, including payments to national carriers.", category: "trade", unit: "current US$", unitShort: "US$", higherIsBetter: true },
  { code: "ST.INT.XPND.CD", id: "wdi-tourism-spending", title: "International tourism expenditure", definition: "Expenditure of Indian travellers abroad, including payments to foreign carriers.", category: "trade", unit: "current US$", unitShort: "US$", higherIsBetter: null },

  // --- Work and distribution ------------------------------------------------
  { code: "SL.UEM.1524.ZS", id: "wdi-youth-unemployment", title: "Youth unemployment", definition: "Share of the labour force aged 15-24 without work but available for and seeking employment.", category: "social", unit: "% of labour force 15-24", unitShort: "%", higherIsBetter: false },
  { code: "SL.SRV.EMPL.ZS", id: "wdi-services-employment", title: "Employment in services", definition: "Share of total employment in the services sector.", category: "social", unit: "% of employment", unitShort: "%", higherIsBetter: null },
  { code: "SI.DST.FRST.20", id: "wdi-income-share-bottom20", title: "Income share of the poorest fifth", definition: "Share of national income or consumption held by the poorest 20% of the population.", category: "social", unit: "% of income", unitShort: "%", higherIsBetter: true },

  // --- Energy transition ----------------------------------------------------
  { code: "EG.ELC.COAL.ZS", id: "wdi-electricity-coal", title: "Electricity from coal", definition: "Share of electricity generated from coal sources.", category: "energy", unit: "% of output", unitShort: "%", higherIsBetter: false, note: "Renewable capacity headlines and generation share are different claims. This is the one that determines emissions." },
  { code: "EG.ELC.NUCL.ZS", id: "wdi-electricity-nuclear", title: "Electricity from nuclear", definition: "Share of electricity generated from nuclear sources.", category: "energy", unit: "% of output", unitShort: "%", higherIsBetter: null },
];
